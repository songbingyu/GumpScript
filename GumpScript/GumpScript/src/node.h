...
public:
	NAssignment(NIdentifier& lhs, NExpression& rhs) : lhs_(lhs_), rhs_(rhs) { }
	virtual llvm::Value* codeGen(CodeGenContext& context) {}
...
class NFunctionDeclartion : public NStatement {
public:
	NFunctionDeclartion(const NIdentifier& type, const NIdentifier& id,
